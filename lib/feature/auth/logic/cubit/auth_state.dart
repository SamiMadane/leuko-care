...
class AuthState<T> with _$AuthState<T> {
  ...
  const factory AuthState.loginSuccess(User user,String userType) = LoginSuccess;
  ...
  const factory AuthState.signedOutStateError(String message) = SignedOutStateError;
}
