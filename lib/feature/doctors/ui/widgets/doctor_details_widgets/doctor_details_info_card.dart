      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const Divider(),
            _buildRowInfo(Icons.work, 'Experience', '${doctor.experience} years'),
            const Divider(),
            _buildRowInfo(Icons.info_outline, 'Description', doctor.description),
            const Divider(),
            _buildRowInfo(Icons.people, 'Patients Count', '$patientsCount'),
          ],
        ),
      ),
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  title,
                  style: getSemiBoldTextStyle(fontSize: FontSizeManager.s16, color: ColorsManager.darkBlue)
                ),
                 SizedBox(height: HeightManager.h6),
                Text(
                  value,
                  style: getRegularTextStyle(fontSize: FontSizeManager.s14,color:ColorsManager.black87)
                ),
              ],
            ),
          ),
