      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: ColorsManager.profileBackGroundColor.withValues(alpha: 0.4), // تغيير اللون حسب الحاجة
                blurRadius: 10, // درجة الضبابية للشادو
                offset: Offset(0, 5), // تموضع الشادو
              ),
            ],
          ),
          child: CircleAvatar(
