...
class RadiusManager {
  ...
  static double r34 = SizeUtil.setRadius(34.0);
  static double r35 = SizeUtil.setRadius(35.0);
...
class WidthManager {
  ...
  static double w42 = SizeUtil.setWidth(42.0);
...
class HeightManager {
  ...
  static double h0 = SizeUtil.setHeight(0.0);
  static double h1 = SizeUtil.setHeight(1.0);
  static double h1_1 = SizeUtil.setHeight(1.1);
  static double h1_2 = SizeUtil.setHeight(1.2);
  ...
  static double h5 = SizeUtil.setHeight(5.0);
  ...
  static double h42 = SizeUtil.setHeight(42.0);
  ...
  static double h68 = SizeUtil.setHeight(68.0);
  ...
  static double h185 = SizeUtil.setHeight(185.0);
  static double h190 = SizeUtil.setHeight(190.0);
